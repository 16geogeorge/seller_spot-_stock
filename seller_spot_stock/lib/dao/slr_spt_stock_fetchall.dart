class StockFetchList {
  List<StockFetchAll> stockFetchList = new List();

  List<StockFetchAll> parseFromServerResponse(Map json) {

    stockFetchList.clear();
    if (null != json && json.isNotEmpty) {
      ...
      StockFetchAll item = StockFetchAll.fromJson(results);

      stockFetchList.add(item);

    }
    return stockFetchList;
  }
}
...
class StockFetchAll {
  ...
  StockFetchAll({this.stockData});

  StockFetchAll.fromJson(Map<String, dynamic> json) {
